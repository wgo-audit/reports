...
Reviewers may reuse the source-bounded observations only with their recorded cutoff, locator, and limitation. They must not infer release-specific implementation, live state, control effectiveness, or production readiness from these public pages.
