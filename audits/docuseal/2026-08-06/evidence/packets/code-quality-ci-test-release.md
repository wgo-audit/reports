...
All commands below used exact working directory `primary-code:.`. No installation or restore was authorized or attempted.
...
Reviewers may reuse the declared-gate and bounded execution observations with their recorded limitations. Green jobs must not be treated as proof of coverage, artifact identity, target correctness, release approval, or production readiness.
