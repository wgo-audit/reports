...
The auditor explicitly authorized `gpt-5.6-terra` as the substitute for unavailable Luna verification workers. [Pass A](cost-luna-pass-a.json) and [Pass B](cost-luna-pass-b.json) were independently recomputed from the unchanged manifest and rate card. Their complete JSON evidence is byte-for-byte identical, SHA-256 `1049bb4a9b2ae666e3f350ff5dce270ac81e5b57e7cef5f7e12baa0eda238de2`:
