...
6. **Time and assess the handoff.** Record elapsed and active time once by activity, assistance needed, unresolved dependency, and whether the successor could locate—not execute—each control. Use [OI-020](../controls/open-items.md#oi-020) to establish evidence-based effort; do not infer staffing or cash from the duty map alone.
